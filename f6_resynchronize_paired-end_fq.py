...
Obtained from https://github.com/enormandeau/Scripts/blob/master/fastqCombinePairedEnd.py
Sep. 17th 2015 Junesk9
"""
...
if __name__ == "__main__":
    ...
    with myopen(in1.split("/")[-1] + "_pairs_R1" + outSuffix, "w") as out1:
        with myopen(in2.split("/")[-1] + "_pairs_R2" + outSuffix, "w") as out2:
            with myopen(in1.split("/")[-1] + "_singles" + outSuffix, "w") as out3:
